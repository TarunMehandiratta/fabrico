  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="name">
        ...
        <li class="nav-item">
          <a class="nav-link" id="contact-tab" data-toggle="tab" href="#feature" role="tab" aria-controls="feature" aria-selected="false">
...
<!--end-modal-->
  ...
  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
		<div class="credit-tabs">
			...
			<h2 class="cal-had">Credito residuo <a data-toggle="modal" data-target="#exampleModal" href="#"> <i class="fa fa-plus" aria-hidden="true"></i> Ricarica credito</a> </h2>
			<div class="pris">€55,00</div>
			
			<h2 class="cal-had">Abbonamento crediti <a href="#"> 
			<i class="fa fa-credit-card-alt" aria-hidden="true"></i> Tutti piani <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
			</h2>
			
			<div class="paino">
				<h5> <img src="images/tower.png"> Paino 50 <span>€50,00/mese</span> 
					<a href="#">Annulla paino</a> 
				</h5>
				<p>Prossimo addebito: <span>22/12/2020</span> </p>
			</div>
			
			<h2 class="cal-had">Abbonamento corsi <a href="#"> 
			<i class="fa fa-users" aria-hidden="true"></i> Tutti corsi <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
			</h2>
			
			<div class="new-by-card">
				<div class="row">
					<div class="col-md-7">
						<div class="card course-card mt-3">
                    <img class="card-img-top course-card-bg" src="images/course_card_bg.png" alt="Card image">
                    <div class="card-img-overlay course-card-body">
                      <div>
                        ...
                        <div class="course-card-body-text">
                          <i class="fa fa-calendar-o" aria-hidden="true"></i> Lun 9:00 - Mar 1700 - Ven 17:00</span>
                        </div>
						<div class="course-card-body-text">
                          <i class="fa fa-clock-o" aria-hidden="true"></i>
                          <span class="course-card-text">60</span>
                      ...
                      <div class="d-flex">
                        <div class="mt-auto">
                          <h3 class="course-card-title w-100 m-0">
                            Total Body can Patrizia
                          </h3>
                          <span class="course-card-text p-0">
                            Total Body, Posturale, Intensiva
                          </span>
                        </div>
                      </div>
                    </div>
					...
					<div class="col-md-5">
						<div class="by-card-txt">
							<label>€35,00/mese</label>
							<p>Prossimo addebito: <span>22/12/2020</span></p>
							<a href="#">Annulla abbonamento</a>
						</div>
					</div>
				</div>
			</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog sabribe-modal" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
          <div class="rate-modal">
            ...
            <div class="form-group mt-4">
              <label>scegli quanto ricaricare</label>
              <input type="text" placeholder="es. 100€">
            </div>
			
			
           <div class="choose-pay">
             <label class="txt">SELEZIONA IL METODO DI PAGAMENTO</label>
            <label class="lists">mario.rossi@gmail.com
              <input type="radio" checked="checked" name="radio">
              <span class="checkmark"></span>
            </label>

            <label class="lists"> <img src="images/pay.png"> Paypal
              <input type="radio" name="radio">
              <span class="checkmark"></span>
            </label>

            <label class="lists"><img src="images/pay-2.png"> Altri metodi
              <input type="radio" name="radio">
              <span class="checkmark"></span>
            </label>
           </div>
           ...
           <div class="form-group mt-4">
             <button type="button">Ricarica Wallet</button>
           </div>
  ...
  <div class="tab-pane fade" id="train" role="tabpanel" aria-labelledby="train-tab">
		<div class="trainee-tab">
			<h2 class="cal-had">Trainer preferiti <a href="#"> <i class="fa fa-clock-o" aria-hidden="true"></i> Vedi tutti i trainer </a> </h2>
					...
					<div class="cera-box">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="maria">
                            <img class="img-fluid" src="images/teacher3.png">
                            <div class="mar-txt">
                              <label>
                              ...
                              <h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">michele giannelli</font></font></h4>
                              <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Specializzato in preparazione fisica sportiva</font></font></span>
                              <div class="up-star"><i class="fa fa-star" aria-hidden="true"></i></div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="maria">
                            <img class="img-fluid" src="images/teacher1.png">
                            <div class="mar-txt">
                              <label>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                              ...
                              <h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Saverio Lauro</font></font></h4>
                              <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Laureato in scienze motorie </font></font></span>
                              <div class="up-star"><i class="fa fa-star" aria-hidden="true"></i></div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="maria">
                            <img class="img-fluid" src="images/teacher4.png">
                            <div class="mar-txt">
                              <label>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                              ...
                              <h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Alessandra maio</font></font></h4>
                              <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Specializzato in yoga ginnastica di mantenimento</font></font></span>
                              <div class="up-star"><i class="fa fa-star" aria-hidden="true"></i></div>
                            </div>
                        </div>
                        </div>
  ...
  <div class="tab-pane fade" id="order" role="tabpanel" aria-labelledby="order-tab">
	...
	<div class="order-in-tab">
		
		<h2 class="cal-had"> I miei ordini </h2>
			...
			<div class="col-md-6">
				<div class="sefer">
					...
					<div class="safe-txt">
						...
						<p>x1</p>
						<p>In consegna</p>
						<p>Track Code: <a href="#">029840GAR54HAJ90</a> </p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="sefer">
					<img src="images/cart4.png">
					<div class="safe-txt">
						<label>Materassino</label>
						<span> 9,99€ </span>
						<p>x2</p>
						<p class="green">Consegnato Il: 02/06/2020</p>
						<p>Track Code: <a href="#">0857HGSI846HUS000</a> </p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="sefer">
					<img src="images/cart4.png">
					<div class="safe-txt">
						<label>Coppia Manubri 2kg</label>
						<span> 4,99€ </span>
						<p>x1</p>
						<p class="green">Consegnato Il: 02/06/2020</p>
						<p>Track Code: <a href="#">0857HGSI846HUS000</a> </p>
  ...
  <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
      ...
      <h2 class="cal-had mb-4">Modifica password </h2>
    ...
    <div class="row">
	  ...
	  <div class="col-md-6">
        <div class="form-group">
          <label>conferma nouva password</label>
          <div class="input-group">
			  <input type="text" class="form-control" placeholder="Password" aria-label="Recipient's username" aria-describedby="basic-addon2">
			  <div class="input-group-append">
				<span class="input-group-text" id="basic-addon2"><i class="fa fa-eye" aria-hidden="true"></i></span>
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        <div class="form-group">
          <button class="site-btn" type="button"> Conferma modifiche </button>
        </div>
      </div>
  ...
  <div class="tab-pane fade" id="feature" role="tabpanel" aria-labelledby="feature-tab">
      ...
      <div class="cards-slides">
        ...
        <div class="owl-slider">
          <div id="carouse3" class="owl-carousel">
      
            <div class="pay-slide">
              <img class="pay-card" src="images/card.png">
            </div>
          ...
          <a class="pegam" href="#">Aggiungi metodo di pagamento <i class="fa fa-angle-right" aria-hidden="true"></i> </a>


          <h4 class="lsd"> lista ordini </h4>


          <div class="date-detail">
              <div class="date"> 12/06/2020  <span>13,50€</span> </div>
              <p>30' Power Yoga can Giuseppe Ungaretti</p>
              <label><i class="fa fa-credit-card" aria-hidden="true"></i> Visa .... .... .... 0000</label>
          </div>

          <div class="date-detail">
            <div class="date"> 07/06/2020  <span>20,00€</span> </div>
            <p>45' Power Yoga can Giuseppe Ungaretti</p>
            <label> <img src="images/pay.png"> mario.rossi@gmail.com</label>
        </div>

        <div class="date-detail">
          <div class="date"> 21/05/2020  <span>30,00€</span> </div>
          <p>90' Power Yoga can Giuseppe Ungaretti</p>
          <label> <img src="images/pay.png"> mario.rossi@gmail.com</label>
      </div>
